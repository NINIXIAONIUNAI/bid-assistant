...
export const mockCases: KbCase[] = [
  {
    ...
    date: "2024-12",
    place: "长沙市",
    scope: "HIS/EMR 系统建设监理",
    outcome: "顺利通过验收，获评 A 级",
  },
  {
    id: "k2",
    name: "岳麓区学校智慧校园建设监理",
...
export const mockFinancials: KbFinancial[] = [
  {
    id: "f1",
    name: "2025 年度审计报告",
    period: "2025 年",
